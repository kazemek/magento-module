...
class RpPieperCustom_Ratepayelv_Block_Adminhtml_Log
    extends RpPieperCustom_Ratepayelv_Block_Adminhtml_Logs_Grid
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function __construct()
    {
        parent::__construct();
        if ($this->isLogEntry()) {
            $this->setTemplate('ratepayelv/sales/order/view/tab/log.phtml');
        }
    }
   ...
   /**
    ...
    {
        return !Mage::helper('ratepayelv/payment')->isRatepayPayment($this->getOrder()->getPayment()->getMethod());
    }
    ...
    {
        $log = Mage::getModel('ratepayelv/logging')->load($this->getRequest()->getParam('log_id'));
