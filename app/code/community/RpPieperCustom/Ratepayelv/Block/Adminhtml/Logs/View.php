...
class RpPieperCustom_Ratepayelv_Block_Adminhtml_Logs_View extends Mage_Adminhtml_Block_Widget_View_Container
{
    /**
     * Construct
     */
    public function __construct()
    {
        ...
        $this->_mode        = 'view';
        $this->_headerText  = Mage::helper('ratepayelv')->__('Pi Log');
