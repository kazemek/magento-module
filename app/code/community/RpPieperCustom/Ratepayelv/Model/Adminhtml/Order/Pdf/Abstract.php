...
abstract class RpPieperCustom_Ratepayelv_Model_Adminhtml_Order_Pdf_Abstract extends Mage_Sales_Model_Order_Pdf_Abstract {
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true) {
        ...
        if ($order->getPayment()->getMethodInstance()->getCode() == 'ratepayelv_rechnung') {
