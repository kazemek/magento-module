...
abstract class RpPieperCustom_Ratepayelv_Model_Method_Abstract extends Mage_Payment_Model_Method_Abstract
{
    /**
     * Method code
     *
     * @var string
     */
    protected $_code = 'ratepayelv_abstract';
