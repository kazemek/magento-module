...
class RpPieperCustom_Ratepayelv_Helper_Email extends Mage_Core_Helper_Abstract
{
    /**
    ...
    public function sendNewCreditmemoEmail($creditmemo)
    {
        ...
        $mailer->setTemplateParams(array(
                ...
                'logo' => '<img src="' . Mage::getDesign()->getSkinUrl() . 'images/ratepayelv/ratepay.png" alt="RatePAY Logo" width="90px" height="25px" style="margin-left:5px;"/>',
                'due_days' => Mage::getStoreConfig('payment/' . $order->getPayment()->getMethod() . '/due_days', $order->getStoreId())
            )
        );
        $mailer->send();
