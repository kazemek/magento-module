...
class PayIntelligent_Ratepay_Model_Method_Prepayment extends PayIntelligent_Ratepay_Model_Method_Abstract
{
    /**
     * Payment code
     * 
     * @var string 
     */
    protected $_code = 'ratepay_prepayment';
     ...
     * @var string 
     */
    protected $_formBlockType = 'ratepay/payment_form_prepayment';
     ...
     * @var string
     */
    protected $_infoBlockType = 'ratepay/payment_info_prepayment';
